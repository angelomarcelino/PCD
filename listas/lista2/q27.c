...
int main(int argc, char* argv[]) {
	...
	if (my_rank == 0) {
		...
		switch (global_n) {
			case 120:
				printf("Speedup: %.2f, Eficiencia: %.3f\n", 15.52 / (max * mult), 15.52 / (max * mult * p));
				break;
			case 1200:
				printf("Speedup: %.2f, Eficiencia: %.3f\n", 168.74 / (max * mult), 168.74 / (max * mult * p));
				break;
			case 12000:
				printf("Speedup: %.2f, Eficiencia: %.3f\n", 1678.69 / (max * mult), 1678.69 / (max * mult * p));
				break;
			case 120000:
				printf("Speedup: %.2f, Eficiencia: %.3f\n", 13022.71 / (max * mult), 13022.71 / (max * mult * p));
				break;
			case 1200000:
				printf("Speedup: %.2f, Eficiencia: %.3f\n", 142291.87 / (max * mult), 142291.87 / (max * mult * p));
				break;
			default:
				break;
		}
